...
class SyntheticData:
    ...
    def save(self):
        ...
        data_filename = os.path.join("./data/datasets", f"{self.identifier}_ground_data.csv")
        network_filename = os.path.join("./data/networks", f"{self.identifier}_ground_network.pkl")
